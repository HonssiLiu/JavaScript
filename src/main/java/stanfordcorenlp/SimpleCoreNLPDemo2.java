...
//		}
		...
		Sentence sen = new Sentence ("shenyang pharmaceutical university");
		System.out.println(sen.lemmas());
		System.out.println(sen.posTags());
		//System.out.println(sen.dependencyGraph());
	}
